...
-   En esta sección explicaré cómo usar R Markdown, si así lo deseas, puedes ver la clase que hice sobre este tema en este [link](https://www.youtube.com/watch?v=RQ0UdWYmpFM).
...
-   En html, la mejor opción es usar la función `reactable` del package
    `reactable``, ya que es una opción interactiva.
